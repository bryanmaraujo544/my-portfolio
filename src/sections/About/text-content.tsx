...
const textContent = {
  pt: {
    title: 'Sobre Mim',
    mainText: [
      'Olá! Meu nome é Bryan e sou apaixonado por desenvolver aplicações para a web. Busco evoluir a cada dia por meio de estudos teóricos alinhados a muita prática!',
      <>
      ...
      <>
        ...
        me aperfeiçoar nas duas esferas.
      </>,
    ],
  },
  en: {
